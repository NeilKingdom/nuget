...
gcc -g -Iinclude -c src/csv.c -o obj/csv.o -lm -lcurses
...
gcc -g obj/common.o obj/table.o obj/curses_helpers.o obj/csv.o obj/settings.o obj/main.o -o nuget -lm -lcurses
