 ...
 */
static char *n_itoa(const uint64_t n) {
    int i, tmp = n;
    unsigned digits = 0;
    char *a = NULL;
 ...
 */
static uint64_t n_atoi(const char* const a) {
    return 0;
}
 ...
 */
static char *n_dtoa(const double d) {
    return NULL;
}
 ...
 */
static double n_atod(const char* const a) {
    return 0.0;
}
 ...
 */
static Color_t hex_to_rgb(const char* const hex) {
